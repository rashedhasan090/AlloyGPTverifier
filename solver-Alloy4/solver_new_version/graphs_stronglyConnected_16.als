...
/*
The graph is weakly connected, ie, it is possible to reach every node 
from every node ignoring edge direction.
http://mathworld.wolfram.com/WeaklyConnectedDigraph.html
*/
pred weaklyConnected {
    all n1, n2:Node | Node in n1.*(adj+~adj).n2
}
/*
The graph is strongly connected, ie, it is possible to reach every node from every node 
...
/*
The graph is transitive, ie, if two nodes are connected through a third node, 
they also are connected directly.
